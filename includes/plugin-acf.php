<?php
    ...
    if (function_exists('acf_add_options_page')) {
        acf_add_options_page(
            [
                'page_title' => 'پیشخوان هاستر',
                'menu_title' => 'پیشخوان هاستر',
                'menu_slug' => 'larateam_hoster',
        ...
        acf_add_options_sub_page(
            [
                ...
                'menu_slug' => 'larateam_hoster_general',
                'capability' => 'manage_options',
                'parent_slug' => 'larateam_hoster',
                'update_button' => __('بروزرسانی اطلاعات', 'acf'),
                'updated_message' => __("اطلاعات بروزرسانی شد.", 'acf'),
            ]
        );
        acf_add_options_sub_page(
            array(
                'page_title' => 'سئو هاستر',
                'menu_title' => 'سئو هاستر',
                'menu_slug' => 'larateam_hoster_seo',
                'capability' => 'manage_options',
                'parent_slug' => 'larateam_hoster',
                'update_button' => __('بروزرسانی اطلاعات', 'acf'),
                'updated_message' => __("اطلاعات بروزرسانی شد.", 'acf'),
        ...
        acf_add_options_sub_page(
            array(
                'page_title' => 'پیشنهاد ویژه',
                'menu_title' => 'پیشنهاد ویژه',
                'menu_slug' => 'larateam_hoster_special',
                'capability' => 'manage_options',
                'parent_slug' => 'larateam_hoster',
                'update_button' => __('بروزرسانی اطلاعات', 'acf'),
                'updated_message' => __("اطلاعات بروزرسانی شد.", 'acf'),
        ...
        acf_add_options_sub_page(
            [
                'page_title' => 'جسنجوی دامنه',
                'menu_title' => 'جسنجوی دامنه',
                'menu_slug' => 'larateam_hoster_searchdomain',
                'capability' => 'manage_options',
                'parent_slug' => 'larateam_hoster',
                'update_button' => __('بروزرسانی اطلاعات', 'acf'),
                'updated_message' => __("اطلاعات بروزرسانی شد.", 'acf'),
    ...
    if (function_exists('acf_add_local_field_group')):
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6be7313221',
            'title' => 'اطلاعات شرکت',
            'fields' => array(
                array(
                    'key' => 'field_5fb6be79a2b95',
                    'label' => 'نام شرکت',
                    'name' => 'company_name',
                    'type' => 'text',
                    'instructions' => '',
                ...
                array(
                    'key' => 'field_5fb6bec0a2b9a',
                    'label' => 'جکیده فعالیت ما',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5ba21e78253ae',
            'title' => 'تنظیمات پیشنهاد ویژه',
            'fields' => array(
                array(
                    'key' => 'field_5ba21e8fe2fc1',
                    'label' => 'تیتر پیشنهاد',
                    'name' => 'so-titr',
                    'type' => 'text',
                    'instructions' => '',
                    ...
                    'default_value' => '',
                    'placeholder' => 'هاست پربازدید پارس آنلاین',
                    'prepend' => '',
                    'append' => '',
                    'maxlength' => '',
                ),
                array(
                    'key' => 'field_5ba21f06e2fc2',
                    'label' => 'تاریخ انقضا',
                    'name' => 'so-expire',
                    'type' => 'date_picker',
                    'instructions' => '',
                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            ...
                            'default_value' => '',
                            'placeholder' => '5000 مگابایت فضای میزبانی',
                            'prepend' => '',
                            'append' => '',
                            'maxlength' => '',
                        ),
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5c98c0bfcd32b',
            'title' => 'تنظیمات سئو هاستر',
            'fields' => array(
                array(
                    'key' => 'field_5c98c0d2ba72b',
                    'label' => 'تیتر سایت',
                    'name' => 'site-title',
                    'type' => 'text',
                    'instructions' => '',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6c12c5476a',
            'title' => 'تنظیمات فوتر سایت',
            'fields' => array(
                array(
                    'key' => 'field_5fb6c16a5f267',
                    'label' => 'متن درباره ما',
                    'name' => 'aboutus_footer',
                    'type' => 'textarea',
                    'instructions' => '',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fba7d0e04224',
            'title' => 'تنظیمات نمایش بخش وبلاگ',
            'fields' => array(
                array(
                    'key' => 'field_5fba7d1dfe9b0',
                    'label' => 'نحوه نمایش وبلاگ',
                    'name' => 'blog_type',
                    'type' => 'button_group',
                    'instructions' => 'مطالب وبلاگ چگونه نمایش داده شود؟',
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array(
                        'width' => '',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6c04bf301b',
            'title' => 'جستجوی دامنه',
            'fields' => array(
                array(
                    'key' => 'field_5fb6c05ab8e40',
                    'label' => 'دامنه اول',
                    'name' => 'first_domain_homepage',
                    'type' => 'group',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
                ...
                array(
                    'key' => 'field_5fb6c08cb8e43',
                    'label' => 'دامنه دوم',
                    'name' => 'second_domain_homepage',
                    'type' => 'group',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
                ...
                array(
                    'key' => 'field_5fb6c0b7896a1',
                    'label' => 'دامنه سوم',
                    'name' => 'third_domain_homepage',
                    'type' => 'group',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
                ...
                array(
                    'key' => 'field_5fb6c0c1896a4',
                    'label' => 'دامنه چهارم',
                    'name' => 'forth_domain_homepage',
                    'type' => 'group',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
            ...
            'location' => array(
                array(
                    array(
                        'param' => 'options_page',
                        'operator' => '==',
                        'value' => 'larateam_hoster_searchdomain',
                    ),
                ),
            ),
            'menu_order' => 0,
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5c98e53da44bb',
            'title' => 'شخصی سازی فهرست',
            'fields' => array(
                array(
                    'key' => 'field_5c98e54bd3ece',
                    'label' => 'آیکون',
                    'name' => 'icon',
                    'type' => 'font-awesome',
                    'instructions' => '',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5c9877c4bdf18',
            'title' => 'فعال / غیرفعال سازی بخش پیشنهاد ویژه',
            'fields' => array(
                array(
                    'key' => 'field_5c9877c4c52a7',
                    'label' => 'پیشنهاد ویژه',
                    'name' => 'special_status',
                    'type' => 'true_false',
                    'instructions' => '',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6dd1931507',
            'title' => 'فعال / غیرفعال سازی بخش جستجوی دامنه',
            'fields' => array(
                array(
                    'key' => 'field_5fb6dd193ccb3',
                    'label' => 'جستجوی دامنه',
                    'name' => 'searchdomain_status',
                    'type' => 'true_false',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5c98c17046329',
            'title' => 'فعال / غیرفعال سازی سئو سایت',
            'fields' => array(
                array(
                    'key' => 'field_5c98c17052685',
                    'label' => 'نمایش کلمات کلیدی پایین سایت',
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6b9e00a17d',
            'title' => 'قالب هاستینگ هاستر',
            'fields' => array(
                array(
                    'key' => 'field_5fb6b93629c72',
                    'label' => '',
                    'name' => '',
                    'type' => 'message',
                    'instructions' => '',
                    ...
                    'message' => 'با سلام خدمت شما وبمستر عزیز :
از اینکه محصول مارا انتخاب کرده اید بسیار خشنودیم . تمامی بخش هایی پنل مدیریت محصول از سمت راست شما قابل انتخاب و کنترل است ، درصورتی که در محصول باگ یا مشکلی پیدا کردید و یا انتقاد و پیشنهادی داشتید به ما اطلاع دهید.

آدرس سایت طراح : larateam.ir
آیدی تلگرام : itreza7',
                    'new_lines' => 'wpautop',
                    'esc_html' => 0,
                ),
                array(
                    'key' => 'field_5fb6b95b892fc',
                    'label' => 'اطلاعات لاینسس شما',
                    'name' => 'license',
                    'type' => 'group',
                    'instructions' => '',
                    'required' => 0,
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5fb6c1eb879ed',
            'title' => 'لینک های مهم',
            'fields' => array(
                array(
                    'key' => 'field_5fb6c23e52c0a',
                    'label' => 'صفحه جستجوی هوشمند',
                    'name' => 'smartsearch',
                    'type' => 'page_link',
                    'instructions' => '',
                    'required' => 0,
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5c9b66dc8afae',
            'title' => 'توضیحات اضافی زیر ناوبار',
            'fields' => array(
                array(
                    'key' => 'field_5c9b66e30f198',
                    'label' => '',
                    'name' => 'text_under_navbar_package',
                    'type' => 'wysiwyg',
                    'instructions' => '',
                    'required' => 0,
                    'conditional_logic' => 0,
        ...
        acf_add_local_field_group(array(
            'key' => 'group_5ba3599fb71f2',
            'title' => 'تنظیمات ویژه پکیج های هاستر',
            'fields' => array(
                array(
                    'key' => 'field_5ba35d4423702',
                    'label' => 'لیست پکیج های این بخش',
                    'name' => 'packagelist',
                    'type' => 'repeater',
                    'instructions' => '',
                    'required' => 0,
                    ...
                    'collapsed' => 'field_5ba35d6323703',
                    'min' => 0,
                    'max' => 0,
                    'layout' => 'row',
                    'button_label' => 'افزودن پکیج',
                    'sub_fields' => array(
                        array(
                            'key' => 'field_5ba35d6323703',
                            'label' => 'نام اختصاری پکیج',
                            'name' => 'nickname',
                            'type' => 'text',
                            'instructions' => '',
                            'required' => 0,
                        ...
                        array(
                            'key' => 'field_5ba35d6c23704',
                            'label' => 'دوره پرداخت پکیج',
                            'name' => 'period',
                            'type' => 'text',
                            'instructions' => '',
                            'required' => 0,
                        ...
                        array(
                            'key' => 'field_5ba35fce16e96',
                            'label' => 'تنظیمات مربوط به بخش جستجوی هوشمند',
                            'name' => '',
                            'type' => 'accordion',
                            'instructions' => '',
                            'required' => 0,
                        ...
                        array(
                            ...
                            'message' => 'در جستجوی پیشرفته قرار بگیرد؟',
                            'default_value' => 0,
                            'ui' => 1,
                            'ui_on_text' => '',
                            'ui_off_text' => '',
                        ...
                        array(
                            'key' => 'field_5ba38150f5c74',
                            'label' => 'محصول تخفیف دار',
                            'name' => '',
                            'type' => 'accordion',
                            'instructions' => '',
                            'required' => 0,
                        ...
                        array(
                            ...
                            'message' => 'آیا این پکیج دارای تخفیف است؟',
                            'default_value' => 0,
                            'ui' => 1,
                            'ui_on_text' => '',
                            'ui_off_text' => '',
